...
/**
 * @brief Construct a new nts::other Component::C4071::C4071 object
 * 
 */

nts::otherComponent::C4071::C4071()
{
    nts::pinInfo temp;
...
bool nts::otherComponent::C4071::calcOrGate(nts::pinInfo pin1, nts::pinInfo pin2)
{
...
void nts::otherComponent::C4071::simulate(std::size_t tick)
{
...
/**
 * @brief Destroy the nts::other Component::C4071::C4071 object
 * 
 */
