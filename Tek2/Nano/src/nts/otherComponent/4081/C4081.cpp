...
/**
 * @brief Construct a new nts::other Component::C4081::C4081 object
 * 
 */

nts::otherComponent::C4081::C4081()
{
    nts::pinInfo temp;
...
bool nts::otherComponent::C4081::calcAndGate(nts::pinInfo pin1, nts::pinInfo pin2)
{
...
void nts::otherComponent::C4081::simulate(std::size_t tick)
{
...
/**
 * @brief Destroy the nts::other Component::C4081::C4081 object
 * 
 */
