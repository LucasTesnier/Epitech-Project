...
int define_base(unsigned int, char const*);
char *go_in_base(char*, int, char const*);
char *mk_cv(int *, unsigned int, char const*, char*);
char *my_putnbr_base(char*, unsigned int, char const*);
