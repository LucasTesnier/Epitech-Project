...
int define_base(unsigned int nbr, char const *base)
{
    int base_value;
...
char *mk_cv(int *stock, unsigned int nbr, char const *base, char *tab)
{
...
char *go_in_base(char *tab, int max_base, char const *base)
{
    int change;
    int i;
    int reverse[1000] = {0};
