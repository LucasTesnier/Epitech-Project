...
** my_put_hexa_nbr_maj.c
** File description:
** put hexa number uppercase
*/
...
void my_put_hexa_nbr_conv_maj(long *res, long max_power, char *str, int i)
{
    long change = 0;
...
void my_put_hexa_nbr_maj(int nbr, int change, int for_print)
{
    ...
    for (i = 0; max_power > 1; max_power /= 16) {
        my_put_hexa_nbr_conv_maj(&res, max_power, str, i);
        i++;
    }
    str[i] = base[res];
