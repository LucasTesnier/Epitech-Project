...
{
    sfVector2f size = {125.0 / 1920 * rpg->window.size.x, \
    ...
    button_set_texture(button, BUTTON_ACTIVE, ACTIVE);
    button_set_texture(button, BUTTON_HOVER, HOVER);
    button_set_texture(button, BUTTON_CLICK, CLICK);
