...
void option_button_one(my_game_t *rpg)
{
    ...
    button_set_texture(rpg->option->menu->btns[0], BUTTON_ACTIVE, ACTIVE);
    button_set_texture(rpg->option->menu->btns[0], BUTTON_HOVER, HOVER);
    button_set_texture(rpg->option->menu->btns[0], BUTTON_CLICK, CLICK);
    button_set_font(rpg->option->menu->btns[0], "assets/fonts/arial.ttf");
    button_set_string(rpg->option->menu->btns[0], "Sound");
    button_set_text_color(rpg->option->menu->btns[0], sfWhite);
    sfText_setPosition(rpg->option->menu->btns[0]->text, \
    (sfVector2f){pos.x + 50, pos.y + 25});
...
void option_button_two(my_game_t *rpg)
{
    ...
    button_set_texture(rpg->option->menu->btns[1], BUTTON_ACTIVE, ACTIVE);
    button_set_texture(rpg->option->menu->btns[1], BUTTON_HOVER, HOVER);
    button_set_texture(rpg->option->menu->btns[1], BUTTON_CLICK, CLICK);
    button_set_string(rpg->option->menu->btns[1], "Music");
    button_set_text_color(rpg->option->menu->btns[1], sfWhite);
    sfText_setPosition(rpg->option->menu->btns[1]->text, \
    (sfVector2f){pos.x + 50, pos.y + 25});
...
void option_button_four(my_game_t *rpg)
{
    ...
    button_set_texture(rpg->option->menu->btns[2], BUTTON_ACTIVE, ACTIVE);
    button_set_texture(rpg->option->menu->btns[2], BUTTON_HOVER, HOVER);
    button_set_texture(rpg->option->menu->btns[2], BUTTON_CLICK, CLICK);
    button_set_font(rpg->option->menu->btns[2], "assets/fonts/arial.ttf");
    button_set_string(rpg->option->menu->btns[2], "Back");
    button_set_text_color(rpg->option->menu->btns[2], sfWhite);
    sfText_setPosition(rpg->option->menu->btns[2]->text, \
    (sfVector2f){pos.x + 50, pos.y + 25});
